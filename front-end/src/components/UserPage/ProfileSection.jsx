        ...
        <div className="flex justify-between items-start mb-8">
          ...
          {!isEditing ? (
            <button
              ...
              className="bg-blue-50 text-blue-600 px-4 py-2 rounded-full text-sm font-medium hover:bg-blue-100 transition-all duration-200 flex items-center space-x-2"
            >
              <svg
                className="w-4 h-4"
                fill="none"
            ...
            <button
              ...
              className="bg-gray-50 text-gray-600 px-4 py-2 rounded-full text-sm font-medium hover:bg-gray-100 transition-all duration-200"
            >
              Cancel
            </button>
          )}
