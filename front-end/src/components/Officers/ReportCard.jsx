...
const ReportCard = ({ report, onView, onAssign, onAddAction }) => {
  ...
  const getStatusColor = (status) => {
    const colors = {
      pending:
        "bg-gradient-to-r from-yellow-50 to-orange-50 text-orange-800 border-orange-200 shadow-orange-100",
      onGoing:
        "bg-gradient-to-r from-blue-50 to-indigo-50 text-blue-800 border-blue-200 shadow-blue-100",
      completed:
        "bg-gradient-to-r from-green-50 to-emerald-50 text-green-800 border-green-200 shadow-emerald-100",
      cancelled:
